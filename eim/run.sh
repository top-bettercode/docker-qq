...
WINEPREFIX="$HOME/.deepinwine/Deepin-QQEIM"
APPDIR="/opt/deepinwine/apps/Deepin-QQEIM"
APPVER="1.90.2220deepin1"
APPTAR="files.7z"
PACKAGENAME="deepin.com.qq.b.eim"
...
CallApp()
{
        BASE_DIR="$HOME/.deepinwine/Deepin-QQEIM"
        ...
        env WINEPREFIX="$BASE_DIR" $WINE_CMD "c:\\Program Files\\Tencent\\QQEIM\\Bin\\QQEIM.exe"
